...
This project focuses on analyzing vendor performance using a dataset that includes key metrics such as total purchases, sales-to-purchase ratio, risk score, and gross profit. The goal of this analysis is to uncover insights that can help improve vendor relationships, optimize sales strategies, and identify top-performing vendors.

The project uses Python, Power BI, and Excel to clean, analyze, visualize, and present data. An interactive Power BI dashboard has been created for real-time analysis of vendor performance.
